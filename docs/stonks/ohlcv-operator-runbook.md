...
The DAG ID is `stonks_ohlcv_eoddata_daily_scrape`. An empty configuration uses
the New York date at Airflow's `data_interval_end`. A bounded manual rerun may
provide:
