...
| Airflow source-completion coordination | A11.1-A11.4 (mechanism, signals, manual DAG, and contract tests frozen in `tech-indicators-airflow-coordination-v1.md`); A11.5-A11.8 wire and verify it |
